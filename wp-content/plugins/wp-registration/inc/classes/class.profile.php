...
class WPR_Profile {
	...
	private function set_user_data( $user_id ) {
	...
	function load_profile_script(){
        ...
        // Bootstrap
        wp_enqueue_style('wpr-bsrp', WPR_URL."/css/bootstrap.min.css");
		...
		// frontent file load
	    wp_enqueue_style('wpr-frontend', WPR_URL."/css/wpr-frontend.css");
	    wp_enqueue_script('wpr-frontend', WPR_URL."/js/wpr-frontend.js", array('jquery'),WPR_VERSION, true);
	    wp_enqueue_script('wpr-profile', WPR_URL."/js/wpr-profile.js", array('jquery'),WPR_VERSION, true);
	    wp_enqueue_script('wpr-profile-uploader', WPR_URL."/js/uploader.js", array('jquery'),WPR_VERSION, true);

	    // croppie photo uploader
	    wp_enqueue_style('wpr-croppie', WPR_URL."/css/croppie.css");
	    wp_enqueue_script('wpr-croppie', WPR_URL."/js/croppie.js", array('jquery'),WPR_VERSION, true);


        // font-awesome and ionic icons 
        wp_enqueue_style('wpr-ftawsome', WPR_URL."/css/font-awesome/css/font-awesome.css");
        wp_enqueue_style('wpr-icon-ii-icon', WPR_URL."/css/wpr-fonticons-ii.css");
        wp_enqueue_style('wpr-icon-fa-icon', WPR_URL."/css/wpr-fonticons-fa.css");
        ...
        wp_enqueue_script('wpr-lib', WPR_URL."/js/wpr-lib.js", array('jquery'), WPR_VERSION, true);      
