...
// // Libraries
if( file_exists( dirname(__FILE__).'/lib/class.mailchimp.php' )) include_once dirname(__FILE__).'/lib/class.mailchimp.php';
if( file_exists( dirname(__FILE__).'/lib/class.sendinblue.php' )) include_once dirname(__FILE__).'/lib/class.sendinblue.php';
...
class WPR_MAIN {
    ...
    function __construct(){
        ...
        **/
        ...
        // Rendering reCaptcha
        add_action( 'wpr_before_submit_button', 'wpr_hooks_render_recaptcha', 10, 1);
